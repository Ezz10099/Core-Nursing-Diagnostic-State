...
- Available/considered departments also include Burns and Orthopedics; if these are a combined Burns/Orthopedics ward, treat it as one rotation option.
...
- Revised recommended broad-readiness sequence given prior undergraduate exposure: 1) General/Internal Medicine, 2) Emergency Department, 3) General Surgery/postoperative ward, 4) Burns/Orthopedics if combined; if separate, Burns is a higher-priority unique acute-care exposure and Orthopedics follows General Surgery due to overlap, 5) ICU. Maternity/Obstetrics and Pediatrics remain valuable later rotations or substitutions depending mandatory requirements, career goals, and available time.
- Rationale: Internal Medicine remains the best first transition into internship-level responsibility because it concentrates medication administration, IV care, assessment, documentation, common conditions and deterioration recognition. Prior undergraduate exposure allows Emergency to move earlier. Surgery consolidates postoperative/wound/drain/procedural care. Burns adds distinctive fluid, airway, wound, infection, pain and temperature-management demands; Orthopedics adds neurovascular assessment, compartment-syndrome recognition, casts/traction, mobility/fall and DVT prevention but overlaps more with general surgical nursing. ICU is best after broader acute-care consolidation.
