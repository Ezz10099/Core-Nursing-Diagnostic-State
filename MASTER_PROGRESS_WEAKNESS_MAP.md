...
- atrial fibrillation pulse assessment: learner encountered an AF patient whose pulse/rate was described as irregular but with otherwise normal quantity/strength. Reinforce that AF classically produces an irregularly irregular rhythm, but the ventricular rate may still be within a normal range when rate-controlled and peripheral pulse amplitude/perfusion can remain normal in a stable patient. Assess rate, rhythm and strength separately; compare apical and radial rates if a pulse deficit is suspected because some ventricular contractions may not produce a palpable peripheral pulse. Escalate for new AF or signs of decreased cardiac output such as hypotension, weak pulses, dizziness/syncope, chest pain, dyspnoea, confusion or other instability. Needs ECG/pulse-assessment application retest.
