...
- Learner confirmed the ward-name interpretations used for study: Vasocore = isosorbide mononitrate; Fraxiparine = nadroparin; Clexane = enoxaparin; Metcardium = metoprolol; ASA = aspirin; Plavix = clopidogrel; Concor = bisoprolol; Lipdix = local statin/lipid-lowering product; Pantover = pantoprazole; Farigm = dapagliflozin; Levoc = levofloxacin; Medium = betahistine 16 mg; Lasix = furosemide; Flagyl = metronidazole; Ventolin = salbutamol/albuterol. Exact product strength/concentration and preparation must still be verified from the package/order before administration.
